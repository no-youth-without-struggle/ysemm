...
public class AverageCapitalPlusInterestUtils {
    ...
    public static void main(String [] args){
        double v = AverageCapitalPlusInterestUtils.getPerMonthPrincipalInterest(10000, 0.3, 10);
        System.out.println("等额本息还款:每月偿还本金和利息"+v);
        Map<Integer, BigDecimal> map = AverageCapitalPlusInterestUtils.getPerMonthInterest(10000, 0.3, 10);
        System.out.println("每月还款利息："+map);
        Map<Integer, BigDecimal> decimalMap = AverageCapitalPlusInterestUtils.getPerMonthPrincipal(10000, 0.3, 10);
        System.out.println("等额本息计算获取还款方式为等额本息的每月偿还本金"+decimalMap);
        double interestCount = AverageCapitalPlusInterestUtils.getInterestCount(10000, 0.3, 10);
        System.out.println("总利息"+interestCount);
        double principalInterestCount = AverageCapitalPlusInterestUtils.getPrincipalInterestCount(10000, 0.3, 10);
        System.out.println("总金额"+principalInterestCount);
    }
}