...
public class AverageCapitalUtils {
    ...
    public static void main(String[] args) {
        Map<Integer, Double> s1 = AverageCapitalUtils.getPerMonthPrincipalInterest(10000, 0.3, 10);
        System.out.println("每月还款额度"+s1);
        double s2 = AverageCapitalUtils.getPerMonthPrincipal(10000, 10);
        System.out.println("每月还款的本金"+s2);
        Map<Integer, Double> s3 = AverageCapitalUtils.getPerMonthInterest(10000, 0.3, 10);
        System.out.println("每月还款利息"+s3);
        double s4 = AverageCapitalUtils.getInterestCount(10000, 0.3, 10);
        System.out.println("总利息"+s4);
